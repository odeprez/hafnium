...
#define MANIFEST_REGION_ATTR_READ UINT32_C(1)
#define MANIFEST_REGION_ATTR_WRITE UINT32_C(2)
#define MANIFEST_REGION_ATTR_EXEC UINT32_C(4)
#define MANIFEST_REGION_ATTR_SECURITY UINT32_C(8)
